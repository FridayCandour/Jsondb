 ...
 *     ************************************
 * 
 *     github > www.github.com/FridayCandour/JsonDB
 *
            ...
            if (element[prop] === incoming[prop]) {
              throw new Error(
                "JSONDB: error failed to validate incoming data because " +
                  ...
                  " is unique for " +
                  this.self.name +
                  " Schema can't have more than one instance for this unique prop"
              );
            }
          }
        }
 ...
 // Creates a new JSONDB instance
  ...
  init(config) {
    ...
    // getting keys
      ...
      console.log(`
   \x1B[1m   \x1B[33m Welcome to JsonDB version ${JSONDBversion}, Your JSONDB Database is now created!  \x1B[39m  \x1B[22m

      \x1B[32m
      \x1B[1m  check the root folder for manual inspection! \x1B[22m
      \x1B[34m

 \x1B[3m \x1B[33m NB: Compulsory read \x1B[23m
       \x1B[31m
     - Don't try to edit the generated json database directly
